// Layout fixo do Andar 1 - FUNDAMENTAL_1_1
// Posições das salas, corredores e portas
// Última atualização: 2025-12-20 19:14 - Porta solta removida

export const ANDAR01_LAYOUT = {
    canvasWidth: 1200,
    canvasHeight: 720,
    ...
    roomLayouts: [
        ...
        {
            roomId: 'science-lab-a1',
            x: 10, y: 160, w: 170, h: 120,
            color: '#10b981'
        },
        {
            roomId: 'computer-lab-a1',
...
export const ANDAR01_WALKABLES = [
    ...ANDAR01_LAYOUT.roomLayouts,
    ...ANDAR01_LAYOUT.corridors,
    ...ANDAR01_LAYOUT.doors,
];
